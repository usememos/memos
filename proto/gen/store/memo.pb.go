...
type MemoPayload struct {
	...
	// Format: memos/{memo}
	MemoRefNames  []string `protobuf:"bytes,4,rep,name=memo_ref_names,json=memoRefNames,proto3" json:"memo_ref_names,omitempty"`
...
func (x *MemoPayload) GetMemoRefNames() []string {
	if x != nil {
		return x.MemoRefNames
	}
	return nil
}
