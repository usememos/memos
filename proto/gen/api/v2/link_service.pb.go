...
func (x *GetLinkMetadataResponse) GetMetadata() *LinkMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_api_v2_link_service_proto_goTypes = []interface{}{
	(*LinkMetadata)(nil),            // 0: memos.api.v2.LinkMetadata
...
var file_api_v2_link_service_proto_depIdxs = []int32{
	0, // 0: memos.api.v2.GetLinkMetadataResponse.metadata:type_name -> memos.api.v2.LinkMetadata
