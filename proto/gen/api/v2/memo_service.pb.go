...
var file_api_v2_memo_service_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbc, 0x03, 0x0a, 0x04, 0x4d, 0x65, 0x6d, 0x6f, 0x12, 0x0e,
	...
	0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x65, 0x6d, 0x6f, 0x73, 0x2e,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x65, 0x6d, 0x6f, 0x73, 0x2e, 0x61,
	...
	0x70, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x70, 0x69,
	0x6e, 0x6e, 0x65, 0x64, 0x22, 0x67, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65,
	...
	0x79, 0x52, 0x0a, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0x3c, 0x0a,
	0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x6d, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x52, 0x04, 0x6d, 0x65, 0x6d, 0x6f, 0x22, 0x5b, 0x0a, 0x10, 0x4c,
	...
	0x6d, 0x65, 0x6d, 0x6f, 0x22, 0x63, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65,
	...
	0x03, 0x32, 0xe2, 0x04, 0x0a, 0x0b, 0x4d, 0x65, 0x6d, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x66, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x6d, 0x6f, 0x12,
	...
	0x6f, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x8e, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
...
var file_api_v2_memo_service_proto_goTypes = []interface{}{
	...
	(*Node)(nil),                      // 14: memos.api.v2.Node
}
var file_api_v2_memo_service_proto_depIdxs = []int32{
	12, // 0: memos.api.v2.Memo.row_status:type_name -> memos.api.v2.RowStatus
	13, // 1: memos.api.v2.Memo.create_time:type_name -> google.protobuf.Timestamp
	13, // 2: memos.api.v2.Memo.update_time:type_name -> google.protobuf.Timestamp
	13, // 3: memos.api.v2.Memo.display_time:type_name -> google.protobuf.Timestamp
	14, // 4: memos.api.v2.Memo.nodes:type_name -> memos.api.v2.Node
	...
	2,  // 10: memos.api.v2.CreateMemoCommentRequest.create:type_name -> memos.api.v2.CreateMemoRequest
	1,  // 11: memos.api.v2.CreateMemoCommentResponse.memo:type_name -> memos.api.v2.Memo
	1,  // 12: memos.api.v2.ListMemoCommentsResponse.memos:type_name -> memos.api.v2.Memo
	2,  // 13: memos.api.v2.MemoService.CreateMemo:input_type -> memos.api.v2.CreateMemoRequest
	4,  // 14: memos.api.v2.MemoService.ListMemos:input_type -> memos.api.v2.ListMemosRequest
	6,  // 15: memos.api.v2.MemoService.GetMemo:input_type -> memos.api.v2.GetMemoRequest
	8,  // 16: memos.api.v2.MemoService.CreateMemoComment:input_type -> memos.api.v2.CreateMemoCommentRequest
	10, // 17: memos.api.v2.MemoService.ListMemoComments:input_type -> memos.api.v2.ListMemoCommentsRequest
	3,  // 18: memos.api.v2.MemoService.CreateMemo:output_type -> memos.api.v2.CreateMemoResponse
	5,  // 19: memos.api.v2.MemoService.ListMemos:output_type -> memos.api.v2.ListMemosResponse
	7,  // 20: memos.api.v2.MemoService.GetMemo:output_type -> memos.api.v2.GetMemoResponse
	9,  // 21: memos.api.v2.MemoService.CreateMemoComment:output_type -> memos.api.v2.CreateMemoCommentResponse
	11, // 22: memos.api.v2.MemoService.ListMemoComments:output_type -> memos.api.v2.ListMemoCommentsResponse
