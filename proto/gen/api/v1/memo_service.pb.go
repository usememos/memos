...
type Memo struct {
	...
	Assistant     *Memo_AssistantAttribution `protobuf:"bytes,20,opt,name=assistant,proto3,oneof" json:"assistant,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Memo) GetAssistant() *Memo_AssistantAttribution {
	if x != nil {
		return x.Assistant
	}
	return nil
...
func (x *Memo_AssistantAttribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use Memo_AssistantAttribution.ProtoReflect.Descriptor instead.
func (*Memo_AssistantAttribution) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Memo_AssistantAttribution) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *Memo_AssistantAttribution) GetIcon() string {
	if x != nil {
		return x.Icon
	}
	return ""
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\x12memos.api.v1/SpaceH\x02R\x05space\x88\x01\x01\x12O\n" +
	"\tassistant\x18\x14 \x01(\v2'.memos.api.v1.Memo.AssistantAttributionB\x03\xe0A\x03H\x03R\tassistant\x88\x01\x01\x1a@\n" +
	"\x14AssistantAttribution\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x12\n" +
	"\x04icon\x18\x02 \x01(\tR\x04icon\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
	...
	"\x06_spaceB\f\n" +
	"\n" +
	"_assistantJ\x04\b\x06\x10\aR\fdisplay_time\"u\n" +
	"\bLocation\x12%\n" +
