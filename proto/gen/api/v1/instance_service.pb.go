...
type InstanceSetting_MemoRelatedSetting struct {
	...
	EnableOpengraphLinkPreviews bool `protobuf:"varint,5,opt,name=enable_opengraph_link_previews,json=enableOpengraphLinkPreviews,proto3" json:"enable_opengraph_link_previews,omitempty"`
...
func (x *InstanceSetting_MemoRelatedSetting) GetEnableOpengraphLinkPreviews() bool {
	if x != nil {
		return x.EnableOpengraphLinkPreviews
	}
	return false
}
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	...
	"\x19GetInstanceProfileRequest\"\xde\x0f\n" +
	...
	"\x18enable_double_click_edit\x18\x04 \x01(\bR\x15enableDoubleClickEdit\x12C\n" +
	"\x1eenable_opengraph_link_previews\x18\x05 \x01(\bR\x1benableOpengraphLinkPreviews\x12\x1c\n" +
