...
func file_api_v1_markdown_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_markdown_service_proto_msgTypes[16].Exporter = func(v any, i int) any {
			switch v := v.(*OrderedListItemNode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_markdown_service_proto_msgTypes[17].Exporter = func(v any, i int) any {
			switch v := v.(*UnorderedListItemNode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_markdown_service_proto_msgTypes[40].Exporter = func(v any, i int) any {
