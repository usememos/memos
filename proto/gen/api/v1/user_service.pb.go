...
type UserSetting_GeneralSetting struct {
	...
	UiFont string `protobuf:"bytes,5,opt,name=ui_font,json=uiFont,proto3" json:"ui_font,omitempty"`
	...
	CodeFont      string `protobuf:"bytes,6,opt,name=code_font,json=codeFont,proto3" json:"code_font,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserSetting_GeneralSetting) GetUiFont() string {
	if x != nil {
		return x.UiFont
	}
	return ""
...
func (x *UserSetting_GeneralSetting) GetCodeFont() string {
	if x != nil {
		return x.CodeFont
	}
	return ""
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xf5\x04\n" +
	...
	"\x10webhooks_setting\x18\x05 \x01(\v2).memos.api.v1.UserSetting.WebhooksSettingH\x00R\x0fwebhooksSetting\x1a\xb6\x01\n" +
	...
	"\x05theme\x18\x04 \x01(\tB\x03\xe0A\x01R\x05theme\x12\x1c\n" +
	"\aui_font\x18\x05 \x01(\tB\x03\xe0A\x01R\x06uiFont\x12 \n" +
	"\tcode_font\x18\x06 \x01(\tB\x03\xe0A\x01R\bcodeFont\x1aH\n" +
