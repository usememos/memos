...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * assistant identifies the AI assistant that wrote this memo, when it is an
   * automatic review comment. The memo's creator is still the account it is
   * stored under, which is the reviewed memo's own author.
   *
   * @generated from field: optional memos.api.v1.Memo.AssistantAttribution assistant = 20;
   */
  assistant?: Memo_AssistantAttribution | undefined;
};
...
/**
 * @generated from message memos.api.v1.Memo.AssistantAttribution
 */
export type Memo_AssistantAttribution = Message<"memos.api.v1.Memo.AssistantAttribution"> & {
  /**
...
/**
 * Describes the message memos.api.v1.Memo.AssistantAttribution.
 * Use `create(Memo_AssistantAttributionSchema)` to create a new message.
 */
export const Memo_AssistantAttributionSchema: GenMessage<Memo_AssistantAttribution> = /*@__PURE__*/
