...
/**
 * @generated from message memos.api.v1.GenerateMemoSummaryRequest
 */
export type GenerateMemoSummaryRequest = Message<"memos.api.v1.GenerateMemoSummaryRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message memos.api.v1.GenerateMemoSummaryRequest.
...
/**
 * @generated from message memos.api.v1.GenerateMemoSummaryResponse
 */
export type GenerateMemoSummaryResponse = Message<"memos.api.v1.GenerateMemoSummaryResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.GenerateMemoSummaryResponse.
...
/**
 * @generated from message memos.api.v1.GenerateMemoTagsRequest
 */
export type GenerateMemoTagsRequest = Message<"memos.api.v1.GenerateMemoTagsRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message memos.api.v1.GenerateMemoTagsRequest.
 * Use `create(GenerateMemoTagsRequestSchema)` to create a new message.
 */
export const GenerateMemoTagsRequestSchema: GenMessage<GenerateMemoTagsRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 35);

/**
 * @generated from message memos.api.v1.GenerateMemoTagsResponse
 */
export type GenerateMemoTagsResponse = Message<"memos.api.v1.GenerateMemoTagsResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.GenerateMemoTagsResponse.
 * Use `create(GenerateMemoTagsResponseSchema)` to create a new message.
 */
export const GenerateMemoTagsResponseSchema: GenMessage<GenerateMemoTagsResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 36);

/**
 * @generated from message memos.api.v1.GenerateMemoRelation
 */
export type GenerateMemoRelation = Message<"memos.api.v1.GenerateMemoRelation"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message memos.api.v1.GenerateMemoRelation.
 * Use `create(GenerateMemoRelationSchema)` to create a new message.
 */
export const GenerateMemoRelationSchema: GenMessage<GenerateMemoRelation> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 37);

/**
 * @generated from message memos.api.v1.GenerateMemoRelationsRequest
 */
export type GenerateMemoRelationsRequest = Message<"memos.api.v1.GenerateMemoRelationsRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message memos.api.v1.GenerateMemoRelationsRequest.
 * Use `create(GenerateMemoRelationsRequestSchema)` to create a new message.
 */
export const GenerateMemoRelationsRequestSchema: GenMessage<GenerateMemoRelationsRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 38);

/**
 * @generated from message memos.api.v1.GenerateMemoRelationsResponse
 */
export type GenerateMemoRelationsResponse = Message<"memos.api.v1.GenerateMemoRelationsResponse"> & {
  /**
   * @generated from field: repeated memos.api.v1.GenerateMemoRelation relations = 1;
   */
  relations: GenerateMemoRelation[];
};

/**
 * Describes the message memos.api.v1.GenerateMemoRelationsResponse.
 * Use `create(GenerateMemoRelationsResponseSchema)` to create a new message.
 */
export const GenerateMemoRelationsResponseSchema: GenMessage<GenerateMemoRelationsResponse> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.GenerateMemoSummary
   */
  generateMemoSummary: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.GenerateMemoTags
   */
  generateMemoTags: {
    methodKind: "unary";
    input: typeof GenerateMemoTagsRequestSchema;
    output: typeof GenerateMemoTagsResponseSchema;
  },
  /**
   * GenerateMemoRelations suggests related memos for a memo.
   *
   * @generated from rpc memos.api.v1.MemoService.GenerateMemoRelations
   */
  generateMemoRelations: {
    methodKind: "unary";
    input: typeof GenerateMemoRelationsRequestSchema;
    output: typeof GenerateMemoRelationsResponseSchema;
  },
  /**
