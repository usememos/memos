...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Optional. The reminder time of the memo.
   *
   * @generated from field: google.protobuf.Timestamp remind_time = 19;
   */
