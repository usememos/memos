...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
  ...
  /**
   * The preferred UI font of the user.
   * Either a Google Fonts family name (e.g. "Inter") or empty for the system default.
   *
   * @generated from field: string ui_font = 5;
   */
  uiFont: string;

  /**
   * The preferred monospaced/code font of the user.
   * Either a Google Fonts family name (e.g. "JetBrains Mono") or empty for the system default.
   *
   * @generated from field: string code_font = 6;
   */
  codeFont: string;
};
