...
export type UserStats = Message<"memos.api.v1.UserStats"> & {
   ...
   * Streak statistics.
   *
   * @generated from field: memos.api.v1.UserStats.StreakStats streak_stats = 9;
   */
  streakStats?: UserStats_StreakStats | undefined;
};
 ...
 *
 * @generated from message memos.api.v1.UserStats.StreakStats
 */
export type UserStats_StreakStats = Message<"memos.api.v1.UserStats.StreakStats"> & {
  /**
   ...
   *
   * @generated from field: string last_active_date = 3;
   */
  lastActiveDate: string;
};

/**
 * Describes the message memos.api.v1.UserStats.StreakStats.
 * Use `create(UserStats_StreakStatsSchema)` to create a new message.
 */
export const UserStats_StreakStatsSchema: GenMessage<UserStats_StreakStats> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 9, 1);
