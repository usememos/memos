...
export type UserSetting_TagMetadata = Message<"memos.api.v1.UserSetting.TagMetadata"> & {
  ...
  /**
   * Optional display icon shown in place of the tag's hash mark.
   * When unset, clients fall back to a leading emoji in the tag name, then the hash mark.
   *
   * @generated from field: memos.api.v1.UserSetting.TagMetadata.Icon icon = 3;
   */
  icon?: UserSetting_TagMetadata_Icon | undefined;
};
...
/**
 * @generated from message memos.api.v1.UserSetting.TagMetadata.Icon
 */
export type UserSetting_TagMetadata_Icon = Message<"memos.api.v1.UserSetting.TagMetadata.Icon"> & {
  /**
   * @generated from oneof memos.api.v1.UserSetting.TagMetadata.Icon.value
   */
  value: {
    /**
...
/**
 * Describes the message memos.api.v1.UserSetting.TagMetadata.Icon.
 * Use `create(UserSetting_TagMetadata_IconSchema)` to create a new message.
 */
export const UserSetting_TagMetadata_IconSchema: GenMessage<UserSetting_TagMetadata_Icon> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 20, 1, 0);
