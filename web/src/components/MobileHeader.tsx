...
const MobileHeader = (props: Props) => {
  ...
  return (
    <div className="sticky top-0 pt-4 pb-1 mb-1 backdrop-blur-md flex md:hidden flex-row justify-between items-center w-full h-auto flex-nowrap shrink-0 z-1">
      <div className="flex flex-row justify-start items-center mr-2 shrink-0 overflow-hidden">
        <div
          className="flex md:hidden flex-row justify-center items-center w-6 h-6 mr-1 shrink-0 bg-transparent"
