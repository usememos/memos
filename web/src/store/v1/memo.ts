...
export const useMemoStore = create(
  devtools(
    combine(getDefaultState(), (set, get) => ({
      setState: (state: State) => set(state, undefined, "setState"),
      getState: () => get(),
      fetchMemos: async (request: Partial<ListMemosRequest>) => {
        ...
        set({ memoMapByName: memoMap }, undefined, "fetchMemos");
        return { memos, nextPageToken: nextPageToken || undefined };
      },
      ...
      searchMemos: async (filter: string) => {
        ...
        set({ memoMapByName: memoMap }, undefined, "searchMemos");
        return memos;
      },
      ...
      createMemo: async (request: CreateMemoRequest) => {
        ...
        const memoMap = get().memoMapByName;
        memoMap[memo.name] = memo;
        set({ memoMapByName: memoMap }, undefined, "createMemo");
        return memo;
      },
      updateMemo: async (update: Partial<Memo>, updateMask: string[]) => {
        ...
        const memoMap = get().memoMapByName;
        memoMap[memo.name] = memo;
        set({ memoMapByName: memoMap }, undefined, "updateMemo");
        return memo;
      },
      deleteMemo: async (name: string) => {
        ...
        const memoMap = get().memoMapByName;
        delete memoMap[name];
        set({ memoMapByName: memoMap }, undefined, "deleteMemo");
      },
    })),
    {
      name: "memos_store",
