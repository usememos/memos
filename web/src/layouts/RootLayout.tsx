...
import { SIDEBAR_ICON_RAIL_WIDTH } from "@/components/AppSidebar/sidebar-layout";
...
const RootLayoutContent = () => {
  ...
  // Navigation keeps only the icon rail; the contextual panel (and its width) disappears.
  const railOnlySidebar = getSidebarRouteKind(pathname) === "navigation";
  const sidebarShellWidth = railOnlySidebar ? SIDEBAR_ICON_RAIL_WIDTH : sidebarWidth;
  ...
  return (
    <div
      ...
      style={{ [SIDEBAR_WIDTH_VAR]: `${sidebarShellWidth}px` } as CSSProperties}
    >
      {md && (
