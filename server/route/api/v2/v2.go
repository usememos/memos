...
type APIV2Service struct {
	...
	apiv2pb.UnimplementedMetadataServiceServer
...
func NewAPIV2Service(secret string, profile *profile.Profile, store *store.Store, grpcServerPort int) *APIV2Service {
	...
	apiv2pb.RegisterMetadataServiceServer(grpcServer, apiv2Service)
...
func (s *APIV2Service) RegisterGateway(ctx context.Context, e *echo.Echo) error {
	...
	if err := apiv2pb.RegisterMetadataServiceHandler(context.Background(), gwMux, conn); err != nil {
		return err
	}
