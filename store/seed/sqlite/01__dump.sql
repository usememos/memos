-- Demo User removed for security reasons
-- Default users with weak passwords pose a critical security risk
-- Users should create their own accounts through the registration process
