...
func (s *Store) UpsertMemoResourceV1(ctx context.Context, upsert *UpsertMemoResource) (*MemoResource, error) {
...
func (s *Store) DeleteMemoResourceV1(ctx context.Context, delete *DeleteMemoResource) error {
	tx, err := s.db.BeginTx(ctx, nil)
	if err != nil {
